# Run SmartUI Visual Tests with Selenium and Node.js on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run SmartUI visual regression tests with Selenium and Node.js on real browsers. This sample shows how to configure Node.js + Selenium + SmartUI to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/smartui-node-sample && cd smartui-node-sample
cd sdk && npm install
```
